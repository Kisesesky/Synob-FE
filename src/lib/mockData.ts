...
export const INITIAL_MESSAGES: { [key: number]: Message[] } = {
  1: [
    {id: 1 as MessageId, authorId: 2 as UserId, text: '안녕하세요! Synology 서버의 채팅 채널에 오신 것을 환영합니다.', timestamp: '2025-09-27T10:00:00.000Z', reactions: {'👍': [2 as UserId, 3 as UserId, 4 as UserId]}},
    ...
    {id: 4 as MessageId, authorId: 3 as UserId, text: '오늘의 공지사항입니다.', timestamp: '2025-09-29T11:30:00.000Z'},
  ...
  2: [
    {id: 7 as MessageId, authorId: 3 as UserId, text: '랜덤 채널에 오신 것을 환영합니다.', timestamp: '2025-09-26T09:00:00.000Z'},
  ...
  5: [
    {id: 12 as MessageId, authorId: 2 as UserId, text: 'Next.js 14 문서 업데이트 확인해주세요.', timestamp: '2025-09-29T09:00:00.000Z'},
  ],
  6: [
